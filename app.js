...
async function buscarEnConocimiento(consulta) {
    ...
    /* ---------------------------------------------------------
       ...
       Ya no se toma el primer archivo que coincide.
       --------------------------------------------------------- */
    ...
    /* ---------------------------------------------------------
       ...
       Esto evita depender solamente del índice.
       --------------------------------------------------------- */
    ...
    /* ---------------------------------------------------------
       PASO 3:
       Ganador final = índice + evidencia real del contenido.
       --------------------------------------------------------- */
    ...
    const textoLimpio = mejor.mejorFragmento.texto
        .replace(/[*_#`=-]/g, '')
        .trim();
    ...
    return `📖 **marIA — ${mejor.titulo}**<br><br>"${textoLimpio}"`;
}
